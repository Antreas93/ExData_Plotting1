...
plot(x=Date_Time,y=EPC$Global_active_power,xlab=" ",
     lty=1,ylab = "Global Active Power",type="l")
plot(x=Date_Time,y=EPC$Voltage,xlab="datetime",
     lty=1,ylab = "Voltage",type="l")
...
plot(x=Date_Time,y=EPC$Global_reactive_power,xlab="datetime",
     lty=1,ylab = "Global_reactive_power",type="l")
dev.off()